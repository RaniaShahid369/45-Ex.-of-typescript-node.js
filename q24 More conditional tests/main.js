...
// Using || (or)
console.log("5 is greater than 10 or 10 is equal to 10");
console.log(5 > 10 || 5 == 5);
console.log("5 is greter than 10 or 10 is not equal to 10");
...
console.log("Is Potato not include in my vegetables array?");
console.log(!vegetables.includes("Potato"));
